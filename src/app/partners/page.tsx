...
export default function PartnersPage() {
  ...
  const partners = [
    ...
    },
    {
      ...
      type: "Community Alliances",
      collaboration: "Connecting collegiate students with family networks, festival celebrations, and community elders in Central Ohio.",
      logoText: "COTC",
    },
    {
    ...
    },
    {
      ...
      collaboration: "We invite Columbus South Asian groceries, restaurants, and alumni patrons to support student festival dinners.",
      logoText: "SPON",
    },
  ];
