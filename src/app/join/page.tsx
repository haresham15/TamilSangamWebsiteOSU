    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 pt-32 pb-24 text-left">
      ...
      <div className="max-w-3xl mb-16">
        ...
        <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
          {locale === "ta"
            ...
            : "Whether you are an incoming freshman, graduate student, or alumni, find your community. No dues, no audition prerequisites for general membership, and everyone is welcome."}
        </p>
      </div>

      {/* 1. GroupMe Interstitial & Gateway Panel */}
      <div className="rounded-3xl glass-panel-elevated p-8 sm:p-12 border border-[var(--border-strong)] shadow-2xl mb-16 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-4 flex justify-center">
          <div className="p-6 rounded-3xl bg-black/60 border border-white/10 text-center shadow-inner">
      ...
      {/* 2. Interactive Interest Forms (Membership vs Performer) */}
        ...
        {!submitted ? (
          <form onSubmit={handleFormSubmit} className="space-y-6 max-w-xl">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-xs outline-none focus:border-[var(--accent-tint)]"
              />
            </div>
          ...
          <div className="py-12 text-center space-y-4 max-w-md mx-auto">
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl glass-panel text-xs text-white font-semibold hover:bg-white/10"
            >
