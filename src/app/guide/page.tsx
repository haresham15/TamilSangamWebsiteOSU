    ...
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 pt-32 pb-24 text-left font-body">
      ...
      <div className="max-w-3xl mb-12">
        ...
        <p className="text-sm sm:text-base text-purple-950/80 leading-relaxed font-body font-medium">
          {locale === "ta"
            ? "ஓஹியோ ஸ்டேட் தமிழ் சங்கத்தின் செயல்பாடுகள், நிகழ்வுகள், மற்றும் வழிகாட்டுதல்கள் பற்றிய விரிவான தகவல்கள். எமது AI வழிகாட்டியும் இந்த அறிவுத் தளத்தைக் கொண்டே பதிலளிக்கிறது."
            : "Everything you need to know about participating in OSU Tamil Sangam — from membership and event logistics to voting rights and our editable knowledge engine."}
        </p>
      </div>
            ...
            {filteredFaqs.length === 0 ? (
              <div className="p-8 text-center bg-white border-2 border-[#250d38]">
                ...
                <p className="text-xs text-[#250d38]">
                  Try asking our <strong>Sangam AI Chatbot</strong> directly using the floating button at the bottom right!
                </p>
              </div>
            ) : (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-purple-200/90 mt-1 max-w-2xl">
                  Every response generated by our Sangam AI Chatbot is strictly verified against the entries below. You can add new club facts, event updates, or custom guidelines, which are immediately indexed!
                </p>
              </div>
