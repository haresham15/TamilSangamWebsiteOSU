    ...
    >
      ...
      */}
      <iframe
        ...
        frameBorder="0"
        allowFullScreen
        // @ts-ignore - Next/React might complain about non-standard attributes but they are fine on iframe
      ...
      {/* Warning Overlay */}
      <div className="absolute bottom-8 left-8 p-4 bg-black/80 text-white font-mono text-sm border border-purple-500 rounded backdrop-blur z-50 max-w-sm pointer-events-none">
        <p className="text-purple-400 font-bold mb-1">SKETCHFAB EMBED ACTIVE</p>
