...
export function SceneLighting() {
  ...
  return (
    <>
      ...
      {/* Secondary Rim Light (Warm Sodium-Vapor Amber) */}
      <spotLight position={[5, 2, -5]} intensity={5.0} color="#FF9F1C" distance={20} angle={0.8} penumbra={0.5} />
      
      {/* Subtle Front Fill so overhead spotlight dominates the coin */}
      <pointLight position={[0, 3, 6]} intensity={1.5} color="#FFE0B2" distance={14} decay={1.8} />
    </>
  );
}
