...
export const GALLERY_ALBUMS: GalleryAlbum[] = [
  ...
  },
  {
    ...
    titleEn: "Powerhouse Pongal Harvest",
    titleTa: "பவர்ஹவுஸ் பொங்கல் விழா",
    ...
    photoCount: 5,
    descriptionEn: "Clay pots, sugarcane stalks, overflowing sweet milk, and exhilarating folk rhythms.",
    ...
    photos: [
      {
        ...
        photographer: "OSU Tamil Sangam Archives",
        eventDate: "Jan 2026",
        tags: ["pongal", "pot", "tradition", "harvest"]
      },
      {
        id: "pp-02",
        albumSlug: "powerhouse-pongal-2026",
        ...
        captionEn: "Our campus folk drummers commanding the room with ancient resonant beats.",
      ...
      },
      {
        ...
        captionEn: "A radial pulli kolam hand-drawn by club members with colored rice flour.",
        captionTa: "உறுப்பினர்கள் அரிசி மாவில் வரைந்த பிரம்மாண்டப் புள்ளிக் கோலம்.",
        imageUrl: "https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=1000&q=80",
        photographer: "Student Photographers",
        eventDate: "Jan 2026",
        tags: ["kolam", "art", "rice-flour", "geometry"]
      },
      {
        id: "pp-04",
        albumSlug: "powerhouse-pongal-2026",
        ...
        photographer: "OSU Tamil Sangam Archives",
        eventDate: "Jan 2026",
        tags: ["food", "banana-leaf", "feast", "payasam"]
      },
      {
        id: "pp-05",
        albumSlug: "powerhouse-pongal-2026",
