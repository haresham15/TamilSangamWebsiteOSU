...
export const COLUMBUS_GUIDE: GuideSpot[] = [
  ...
  },
  {
    ...
    descriptionEn: "Major architectural temple hub for the Central Ohio South Asian community. Celebrates major Tamil festivals like Tamil New Year, Panguni Uthiram, and Navaratri Golu with traditional prasadam.",
    descriptionTa: "மத்திய ஓஹியோவின் முதன்மை ஆலயம்; தமிழ் புத்தாண்டு, பங்குனி உத்திரம், நவராத்திரி கொலு என அனைத்து தமிழ் விழாக்களும் விமரிசையாக நடைபெறும் இடம்.",
    recommendationEn: "Visit on festival Saturdays for temple puliyodharai (tamarind rice) and sweet prasadam.",
    recommendationTa: "விழா நாட்களில் கோவில் புளியோதரையும் சர்க்கரைப் பிரசாதமும் பிரசித்தி பெற்றது.",
